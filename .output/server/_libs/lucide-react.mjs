...
const Backpack = createLucideIcon("backpack", __iconNode$x);
const __iconNode$w = [
...
const BookPlus = createLucideIcon("book-plus", __iconNode$v);
const __iconNode$u = [
  ["path", { d: "M12 7v6", key: "lw1j43" }],
...
const BookmarkPlus = createLucideIcon("bookmark-plus", __iconNode$u);
const __iconNode$t = [
